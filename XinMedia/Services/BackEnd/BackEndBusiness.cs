...
namespace XinMedia.Services.BackEnd
{
    /// <summary>
    /// 
    /// </summary>
    /// <seealso cref="MicroServiceCoreResposity.Implementation.DoBase" />
    /// <seealso cref="XinMedia.Services.Interface.IBackEnd" />
    public partial class BackEndBusiness : DoBase, IBackEnd
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BackEndBusiness"/> class.
        /// 建構子
        /// </summary>
        /// <param name="baselogger">The baselogger.</param>
        /// <param name="httpContextAccessor">The HTTP context accessor.</param>
        public BackEndBusiness(
