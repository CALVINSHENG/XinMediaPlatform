...
{
	/// <summary>
	/// GenUnitBranchSerialDHelper
	/// 依公司/單位代碼取得流水編號
	/// </summary>
	/// <seealso cref="MicroServiceCoreResposity.Implementation.DoBase" />
	public class GenUnitBranchSerialDHelper : DoBase
	{
		...
		public GenUnitBranchSerialDHelper(ILogger<BaseLogger> baselogger) : base(baselogger)
		{
		...
		public GenUnitBranchSerialDHelper(ILogger<BaseLogger> baselogger, string ConnectionString, int EnvironmentVal) : base(baselogger, ConnectionString, EnvironmentVal)
		{
			_baselogger = baselogger;
		}
		...
		/// 建構子初始化方式(3)
		/// </summary>
		public GenUnitBranchSerialDHelper()
		{
		}
		...
		*/
        ...
        /// <param name="unitCode">公司/單位代碼</param>
		...
		)
		{
			...
			try
			{
				...
				* 說明：參數防呆
				*/
                var _unitCode = unitCode;
                _unitCode = string.IsNullOrEmpty(unitCode)
